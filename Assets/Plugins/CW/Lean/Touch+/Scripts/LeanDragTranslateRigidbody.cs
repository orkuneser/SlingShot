    ...
    public class LeanDragTranslateRigidbody : MonoBehaviour
    {
        ...
        protected virtual void FixedUpdate()
        {
            ...
            if (cachedCamera != null && targetSet == true)
            {
                ...
                var posChange = targetScreenPoint;
                posChange.y = 0;
                posChange.z = targetScreenPoint.y;
                var newPosition = cachedCamera.ScreenToWorldPoint(posChange);
                newPosition.y = 0;
                var velocity = (newPosition - oldPosition) / (Time.fixedDeltaTime * power);
